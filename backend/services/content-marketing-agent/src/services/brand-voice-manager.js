...
exports.BrandVoiceManager = void 0;
...
class BrandVoiceManager {
    ...
    initializeBrandVoice() {
        return {
            archetype: config_1.brandVoiceDefaults.archetype,
            toneAttributes: [...config_1.brandVoiceDefaults.toneAttributes],
            vocabulary: {
                preferred: [...config_1.brandVoiceDefaults.vocabulary.preferred],
                avoid: [...config_1.brandVoiceDefaults.vocabulary.avoid]
            },
            writingStyle: { ...config_1.brandVoiceDefaults.writingStyle },
            brandPersonality: { ...config_1.brandVoiceDefaults.brandPersonality },
            examples: [
            ...
            guidelines: [...config_1.brandVoiceDefaults.guidelines]
        };
    }
    async getBrandVoice() {
        return this.brandVoiceConfig;
    }
    async updateBrandVoice(updates) {
        this.brandVoiceConfig = {
            ...this.brandVoiceConfig,
            ...updates
        };
        logger_1.logger.info('Brand voice updated', { updates });
        return this.brandVoiceConfig;
    }
    async analyzeToneCompliance(content) {
        const issues = [];
        const suggestions = [];
        let score = 100;
    ...
    async generateBrandVoicePrompt() {
...
Remember: We empower users with clarity, protect them from hidden dangers, and maintain professional authority while being approachable and human.`;
    ...
    async adaptForPlatform(platform) {
    ...
    async generateContentGuidelines(contentType, platform) {
...
exports.BrandVoiceManager = BrandVoiceManager;
//# sourceMappingURL=brand-voice-manager.js.map