...
export type WidgetType = 'metric_card' | 'line_chart' | 'bar_chart' | 'pie_chart' | 'table' | 'funnel' | 'cohort' | 'heatmap' | 'map';
...
export type ReportType = 'executive_summary' | 'user_engagement' | 'revenue_analysis' | 'product_performance' | 'ai_metrics' | 'custom';
...
export type DataQualityCheckType = 'completeness' | 'validity' | 'consistency' | 'accuracy' | 'timeliness' | 'uniqueness';
