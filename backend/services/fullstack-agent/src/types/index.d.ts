...
export declare const CodeGenerationRequestSchema: any;
...
export declare const ArchitectureDecisionRequestSchema: any;
...
export declare const QualityAssessmentRequestSchema: any;
...
export declare enum HookTrigger {
    ALWAYS = "always",
