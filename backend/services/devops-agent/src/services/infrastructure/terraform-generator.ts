 ...
 * 
 * Generates Terraform configurations from infrastructure templates
 */

import { InfrastructureTemplate, TemplateResource, TemplateVariable } from './iac-engine';
import { createContextLogger } from '@/utils/logger';
import * as yaml from 'js-yaml';

const logger = createContextLogger('TerraformGenerator');
...
export class TerraformGenerator {
   ...
   */
  private async generateMainConfig(template: InfrastructureTemplate): Promise<string> {
   ...
   */
  private async generateResource(resource: TemplateResource): Promise<string> {
   ...
   */
  private async generateVariables(variables: TemplateVariable[]): Promise<string> {
   ...
   */
  private async generateOutputs(outputs: any[]): Promise<string> {
    let config = '# Outputs\n\n';
   ...
   * Generate terraform.tfvars
   */
  private async generateTfVars(variables: Record<string, any>): Promise<string> {
   ...
   * Generate versions.tf
   */
  private async generateVersions(): Promise<string> {
...
`;
   ...
   */
  private async generateBackend(): Promise<string> {
...
`;
   ...
   */
  private generateDataSources(template: InfrastructureTemplate): string {
...
`;
   ...
   * Generate modules
   */
  private async generateModules(template: InfrastructureTemplate): Promise<Record<string, string>> {
   ...
   * Generate VPC module
   */
  private async generateVpcModule(): Promise<string> {
    return `# VPC Module
...
`;
  ...
  private isTaggableResource(resourceType: string): boolean {
  ...
  private async generateVpcModuleVariables(): Promise<string> {
...
`;
  ...
  private async generateVpcModuleOutputs(): Promise<string> {
...
`;
  ...
  private async generateEksModule(): Promise<string> {
    return `# EKS Module - Placeholder
# Full implementation would include EKS cluster, node groups, etc.
`;
  }

  private async generateEksModuleVariables(): Promise<string> {
    return `# EKS Module Variables - Placeholder`;
  }

  private async generateEksModuleOutputs(): Promise<string> {
    return `# EKS Module Outputs - Placeholder`;
  }

  private async generateRdsModule(): Promise<string> {
    return `# RDS Module - Placeholder
# Full implementation would include RDS instance, subnet group, etc.
`;
  }

  private async generateRdsModuleVariables(): Promise<string> {
    return `# RDS Module Variables - Placeholder`;
  }

  private async generateRdsModuleOutputs(): Promise<string> {
